...
/******/ 	var hotCurrentHash = "06dfc1952ffa04e6bb10"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = (function (_React$Component) {
	  ...
	  _createClass(Demo, [{
	    ...
	    value: function handleRadiusChange(e) {
	      ...
	      if (radius > 20 || radius < 0) return alert('请输入0~20之间的数字');
	      this.setState({
	        radius: radius
	      });
	    }
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_srcIndex2['default'], { radius: this.state.radius, alphaChannel: false, src: 'http://lingyucoder-demo.qiniudn.com/imgsliders_1.jpg' }),
	        ',',
	        _react2['default'].createElement(
	          'div',
	          null,
	          _react2['default'].createElement('input', { value: this.state.radius, min: 0, max: 20, type: 'number', onChange: this.handleRadiusChange })
	        )
	      );
	    }
	  }]);
	...
	_react2['default'].render(_react2['default'].createElement(Demo, null), document.getElementById('demo'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libBlurImage = __webpack_require__(226);

	var _libBlurImage2 = _interopRequireDefault(_libBlurImage);

	exports['default'] = _libBlurImage2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blur2 = __webpack_require__(227);

	var _blur3 = _interopRequireDefault(_blur2);

	var BlurImage = (function (_React$Component) {
	  function BlurImage() {
	    _classCallCheck(this, BlurImage);

	    _get(Object.getPrototypeOf(BlurImage.prototype), 'constructor', this).call(this);
	    this._blur = this._blur.bind(this);
	  }

	  _inherits(BlurImage, _React$Component);

	  _createClass(BlurImage, [{
	    key: '_blur',
	    value: function _blur() {
	      var img = _react2['default'].findDOMNode(this);
	      var _props = this.props;
	      var radius = _props.radius;
	      var alphaChannel = _props.alphaChannel;

	      var blurFn = function blurFn() {
	        img.removeEventListener('load', blurFn);
	        (0, _blur3['default'])(img, radius, alphaChannel);
	      };
	      if (img.complete) (0, _blur3['default'])(img, radius, alphaChannel);else img.addEventListener('load', blurFn);
	    }
	  }, {
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('img', _extends({}, this.props, { crossOrigin: 'anonymous' }));
	    }
	  }], [{
	    key: 'propTypes',
	    value: {
	      radius: _react2['default'].PropTypes.number,
	      alphaChannel: _react2['default'].PropTypes.bool
	    },
	    enumerable: true
	  }, {
	    key: 'defaultProps',
	...
	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(228), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "BlurImage.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	function stackBlurCanvasRGBA(canvas, top_x, top_y, width, height, radius) {
	  ...
	  for (y = 0; y < height; y++) {
	    ...
	    stackOut = stackEnd;
	    for (x = 0; x < width; x++) {
	      pixels[yi + 3] = pa = a_sum * mulSum >> shg_sum;
	      if (pa !== 0) {
	        pa = 255 / pa;
	        pixels[yi] = (r_sum * mulSum >> shg_sum) * pa;
	        pixels[yi + 1] = (g_sum * mulSum >> shg_sum) * pa;
	        pixels[yi + 2] = (b_sum * mulSum >> shg_sum) * pa;
	      } else {
	  ...
	  for (x = 0; x < width; x++) {
	    ...
	    for (y = 0; y < height; y++) {
	      p = yi << 2;
	      pixels[p + 3] = pa = a_sum * mulSum >> shg_sum;
	      if (pa > 0) {
	        pa = 255 / pa;
	        pixels[p] = (r_sum * mulSum >> shg_sum) * pa;
	        pixels[p + 1] = (g_sum * mulSum >> shg_sum) * pa;
	        pixels[p + 2] = (b_sum * mulSum >> shg_sum) * pa;
	      } else {
	...
	function stackBlurCanvasRGB(canvas, top_x, top_y, width, height, radius) {
	  ...
	  for (y = 0; y < height; y++) {
	    ...
	    stackOut = stackEnd;
	    for (x = 0; x < width; x++) {
	      pixels[yi] = r_sum * mulSum >> shg_sum;
	      pixels[yi + 1] = g_sum * mulSum >> shg_sum;
	      pixels[yi + 2] = b_sum * mulSum >> shg_sum;
	      r_sum -= r_out_sum;
	      g_sum -= g_out_sum;
	      b_sum -= b_out_sum;
	      r_out_sum -= stackIn.r;
	  ...
	  for (x = 0; x < width; x++) {
	    ...
	    for (y = 0; y < height; y++) {
	      p = yi << 2;
	      pixels[p] = r_sum * mulSum >> shg_sum;
	      pixels[p + 1] = g_sum * mulSum >> shg_sum;
	      pixels[p + 2] = b_sum * mulSum >> shg_sum;
	      r_sum -= r_out_sum;
	      g_sum -= g_out_sum;
	      b_sum -= b_out_sum;
	      r_out_sum -= stackIn.r;
	...
	function blurImage(img, radius, alphaChannel) {
	  var index = [img.src, radius, alphaChannel].join("|");
	  var data;
	  if (data = cache[index]) {
	    img.src = data;
	    return;
	  ...
	  if (!(canvas.getContext && canvas.getContext("2d"))) throw Error("Canvas is not support in your browser");
	  ...
	  if (isNaN(radius) || radius < 1) return;
	  if (alphaChannel) stackBlurCanvasRGBA(canvas, 0, 0, w, h, radius);else stackBlurCanvasRGB(canvas, 0, 0, w, h, radius);
	...
	/* REACT HOT LOADER */ }).call(this); if (true) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(228), foundReactClasses = false; if (makeExportsHot(module, __webpack_require__(59))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "blur.jsx" + ": " + err.message); } }); } } })(); }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(34)(module)))
